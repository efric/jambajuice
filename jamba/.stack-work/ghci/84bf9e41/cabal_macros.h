...
/* package jamba-0.1.0.0 */
#ifndef VERSION_jamba
#define VERSION_jamba "0.1.0.0"
#endif /* VERSION_jamba */
#ifndef MIN_VERSION_jamba
#define MIN_VERSION_jamba(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_jamba */
...
#define CURRENT_PACKAGE_KEY "jamba-0.1.0.0-FJs4niLq6ZbFlGBwxtdcrQ"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "jamba-0.1.0.0-FJs4niLq6ZbFlGBwxtdcrQ"
