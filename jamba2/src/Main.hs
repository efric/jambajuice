...
-}
  case t of 
    ...
    _ -> do
      ...
      defConstraintsNode e1
      defConstraintsNode e2
defConstraintsNode self@(ALit a l) = do
  -- error $ "bad" ++ show self
  case l of
...
defConstraintsNode self@(AIf a e1 e2 e3) = do
 P.unifyNodeType (extractId e1) "bool"
 P.unifyNodeNode (extractId e2) (extractId e3)
 P.unifyNodeNode (extractId self) (extractId e2)
 P.unifyNodeNode (extractId self) (extractId e3)
 defConstraintsNode e1 
 defConstraintsNode e2
